    ...
    return (
        <>
            <div className='searchBar flex h-10 text-lg justify-center text-center leading-10'>
                ...
                <div className='sortDropWrap bg-snow w-1/12 h-full text-jet hover:text-cardinal hover:bg-snowdarker font-bold hover:cursor-pointer' onClick={toggleShowSort}>
                    Sort
                </div>
